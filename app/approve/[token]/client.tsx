...
export function ApprovePageClient({
  ...
  token: string
  initialMode: 'view' | 'edit' | 'reject' | 'feedback'
}) {
  ...
  if (status === 'done') {
    const doneConfig = {
      approve: {
        ...
        bg: 'bg-emerald-50',
        title: 'Poll Approved!',
        message: 'Thank you. The poll has been approved and the HR team has been notified.',
      },
      reject: {
        icon: <XCircle className="h-9 w-9 text-red-500" />,
        bg: 'bg-red-50',
        title: 'Poll Rejected',
        message: 'The poll request has been rejected. The HR team has been notified.',
      },
      feedback: {
        icon: <MessageSquare className="h-9 w-9 text-amber-500" />,
        bg: 'bg-amber-50',
        title: 'Feedback Sent',
        message: 'Your feedback has been recorded. The poll has been sent back for revision.',
      },
    }
    ...
    return (
      <div className="flex min-h-screen items-center justify-center px-4" style={{ background: gradient }}>
        <div className="w-full max-w-md rounded-3xl bg-white px-8 py-10 shadow-2xl text-center">
          <div className={`mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full ${cfg.bg}`}>
            {cfg.icon}
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <button
                  ...
                  disabled={status === 'submitting' || !feedbackRemarks.trim()}
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <button
                  ...
                  disabled={status === 'submitting' || !rejectReason.trim()}
